...
public class MedicamentoUI extends javax.swing.JInternalFrame {

    public MedicamentoUI() {
        initComponents();
        //Carga la tabla de medicamentos
        MedicamentoDAO.cargarTablaMedicamento(tableMedicamento);
        ajustarAnchoColumnas(tableMedicamento);
    }
    ...
    private void initComponents() {
        ...
        tableMedicamento.setAutoResizeMode(0);
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
        ...
        if(validar_datos() == true){
            ...
            medicamento = new Medicamento(nombre,descripcion);
    ...
    private void tableMedicamentoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMedicamentoMouseClicked
        int fila = tableMedicamento.getSelectedRow();

        if (fila >= 0) {
            txtID.setText(tableMedicamento.getValueAt(fila, 0).toString());
            txtNombre.setText(tableMedicamento.getValueAt(fila, 1).toString());
            txtDescripcion.setText(tableMedicamento.getValueAt(fila, 2).toString());
        } else {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if(validar_datos() == true){
            nombre = txtNombre.getText();
            descripcion = txtDescripcion.getText();
            id_medicamento = Integer.parseInt(txtID.getText());

            medicamento = new Medicamento(id_medicamento,nombre,descripcion);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        medicamento = new Medicamento(id_medicamento);
